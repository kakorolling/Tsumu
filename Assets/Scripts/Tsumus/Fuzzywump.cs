...
//스킬 정리해놓아야함
public class Fuzzywump : Tsumu
{
    public override string name { get => "Fuzzywump"; }
    public override int startScore { get => 125; }
    public override int deltaScore { get => 9; }
    public override int requiredlevelTsumu { get => 150; }
    public override int deltaRequiredlevelTsumu { get => 100; }
    public override List<string> color { get => new List<string> { "blue" }; }
    public override List<string> tag { get => new List<string>() { "bear", "cry" }; }
