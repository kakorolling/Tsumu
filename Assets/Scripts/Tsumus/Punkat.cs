...
//스킬 정리해놓아야함
public class Punkat : Tsumu
{
    public override string name { get => "Punkat"; }
    ...
    public override List<string> color { get => new List<string> { "gray" }; }
    public override List<string> tag { get => new List<string>() { "cat" }; }
