...
//스킬 정리해놓아야함
public class Poodoodly : Tsumu
{
    public override string name { get => "Poodoodly"; }
    ...
    public override List<string> color { get => new List<string> { "brown" }; }
    public override List<string> tag { get => new List<string>() { "dog", "ribbon" }; }
