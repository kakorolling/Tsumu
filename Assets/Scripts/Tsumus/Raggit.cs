...
//스킬 정리해놓아야함
public class Raggit : Tsumu
{
    public override string name { get => "Raggit"; }
    ...
    public override List<string> color { get => new List<string> { "green", "white" }; }
    public override List<string> tag { get => new List<string>() { "rabbit" }; }
